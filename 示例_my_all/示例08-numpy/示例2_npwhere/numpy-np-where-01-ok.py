...
#        np.array定义成一维数组只返回一个元素（行），np.array定义成2维数组就返回2个元素（列），np.array定义成2维数组就返回3个元素（高）
...
# # ----------------test1------------ 1维列表数组------ 1个设备 --返回step2二维数组---ok-------------------
#
...
# # -----------------test2-----------2维数组--- 1个设备 ----返回step2二维数组---ok------------------
#
...
# -----------------test3----------- 2维数组--- 2个设备 ----返回step2二维数组 -----------ok-------------------

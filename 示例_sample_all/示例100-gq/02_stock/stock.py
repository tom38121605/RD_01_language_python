...
# 大盘上升趋势 ，高位震荡趋势
# FARUP_LOW, FARUP_HIGH = 50, 70         # 远涨
# FARDOWN_LOW, FARDOWN_HIGH  = 30 , 60   # 远跌

# 大盘下降趋势 ，低位震荡趋势
FARUP_LOW, FARUP_HIGH = 45, 65         # 远涨
...
stock_dividend_struct_dict = {
    "600016": "0.306, -0.400",    # 民生银行
    "600755": "0.220, -0.354",    # 厦门国贸
    "601169": "0.602, -0.318",    # 北京银行
    "605368": "0.110, -0.562",    # 蓝天燃气
    "600681": "0.146, -0.429",    # 百川能源
    "603801": "0.020, -0.792",    # 志邦家居
    "601006": "0.013, -0.354",    # 大秦铁路
    "600300": "0.391, -0.340"     # 维维股份
...
limit_up_callback_struct_dict = {
    "600662": "0.230, -0.417",    # 外服控股
    "600681": "0.146, -0.429",    # 百川能源
    "600814": "0.287, -0.483",    # 杭州解百
    "600755": "0.220, -0.354",    # 厦门国贸
    "600858": "0.278, -0.462",    # 银座股份
    "605368": "0.110, -0.562",    # 蓝天燃气
    "605388": "0.172, -0.600"     # 均瑶健康
...
small_cap_callback_struct_dict = {
    "300891": "0.205, -0.483",    # 惠云钛业
    "605077": "0.058, -0.533",    # 华康股份
    "603759": "0.309, -0.580"     # 海天股份
}
...
dividend_fund_struct_dict = {
    "510720": "0.121, -0.145",    # 红利国企ETF国泰
    "180102": "0.017, -0.620",    # 华夏合肥高新REIT
    "159307": "0.220, -0.126",    # 红利低波100ETF博时
    "513820": "0.346, -0.167",    # 港股通红利ETF汇添富
    "510880": "0.353, -0.136",    # 红利ETF华泰柏瑞
    "515450": "0.820, -0.101",    # 红利低波50ETF南方
    "515300": "0.631, -0.158"     # 300红利低波ETF嘉实
}

# ---------------------- 0.7：超跌基, 远涨远跌字典 ----------------------
overdown_fund_struct_dict = {
    "512290": "0.119, -0.363",  # 生物医药ETF国泰
    "512010": "0.075, -0.393",  # 医药ETF易方达
    "515710": "0.021, -0.433"   # 食品饮料ETF华宝
}
...
performance_reversal_far_dict = {
    "003032": "0.033, -0.757",    # 传智教育
    "300527": "0.258, -0.508",    # ST应急
    "300366": "0.007, -0.780",    # ST创意
    "002124": "0.061, -0.736",    # 天邦食品
    "002122": "0.222, -0.637",    # ST汇洲
    "000698": "0.171, -0.566",    # ST沈化
    "002689": "0.224, -0.577",    # ST远智
    "600624": "0.214, -0.647",    # ST复华
    "600169": "0.104, -0.368",    # ST太重
    "300460": "0.726, -0.470",    # ST惠伦
    "000821": "0.039, -0.726",    # ST京机
    "300173": "0.095, -0.684",    # ST福能
    "000010": "0.290, -0.661",    # *ST美丽
    "000488": "0.152, -0.656",    # ST晨鸣
    "000639": "0.018, -0.799",    # ST西王
    "000826": "0.281, -0.675",    # *ST启环
    "000903": "0.153, -0.704",    # ST云动
    "002055": "0.333, -0.474",    # ST得润
    "002360": "0.195, -0.419",    # ST同德
    "002512": "0.215, -0.603",    # ST达华
    "002691": "0.077, -0.715",    # *ST冀凯
    "002719": "0.171, -0.662",    # ST麦趣
    "301030": "0.071, -0.835",    # *ST仕净
    "600053": "0.046, -0.697",    # *ST九鼎
    "600537": "0.175, -0.723",    # *ST亿晶
    "600734": "0.013, -0.778",    # *ST实达
    "600735": "0.658, -0.440",    # ST新华锦
    "600759": "0.052, -0.778",    # ST洲际石油
    "688201": "0.139, -0.783"     # ST信安
}
...
dividend_stock_date_dict = {
    ...
    # here
    "600681": ["25年报 26/04/29", "除息 过期 26/06/04", "0.9+0.6"],   # 百川能源
    "605368": ["25年报 26/04/29", "大会 过期 26/05/13", "4+0"],       # 蓝天燃气
    "600016": ["25年报 26/03/31", "除息 26/07/02 ", "1.36+0.53"],    # 民生银行
    "603801": ["25年报 26/04/30", "除息 过期 26/06/23", "4.0"],       # 志邦家居
    "600300": ["25年报 26/04/30", "除息 过期 26/05/28", "1.04"],      # 维维股份

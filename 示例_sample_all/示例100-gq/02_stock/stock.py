...
stock_dividend_struct_dict = {
    "600016": "0.429, -0.343",  # 民生银行
    "600755": "0.212, -0.350",  # 厦门国贸
    "601169": "0.686, -0.282",  # 北京银行
    "605368": "0.249, -0.507",  # 蓝天燃气
    "600681": "0.246, -0.379",  # 百川能源
    "603801": "0.017, -0.750",  # 志邦家居
    "601006": "0.017, -0.280",  # 大秦铁路
    "600300": "0.505, -0.286",  # 维维股份
...
limit_up_callback_struct_dict = {
    "600662": "0.293, -0.369",  # 外服控股
    "600681": "0.246, -0.379",  # 百川能源
    "600814": "0.432, -0.425",  # 杭州解百
    "600755": "0.212, -0.350",  # 厦门国贸
    "600858": "0.406, -0.408",  # 银座股份
    "605368": "0.249, -0.507",  # 蓝天燃气
    "605388": "0.292, -0.560",  # 均瑶健康
...
small_cap_callback_struct_dict = {
    "300891": "0.225, -0.490",  # 惠云钛业
    "605077": "0.152, -0.484"   # 华康股份
}
...
dividend_fund_struct_dict = {
    ...
    "510720": "0.284, -0.017",  # 红利国企ETF国泰
    "515450": "0.952, -0.035",  # 红利低波50ETF南方
    "515300": "0.756, -0.094",  # 300红利低波ETF嘉实
    "159307": "0.319, -0.051",  # 红利低波100ETF博时
    "510880": "0.521, -0.029",  # 红利ETF华泰柏瑞
    "513820": "0.492, -0.076",  # 港股通红利ETF汇添富
    "180102": "0.056, -0.539",  # 华夏合肥高新REIT
...
performance_reversal_far_dict = {
    ...
    "300527": "0.443, -0.436",  # ST应急
    "300366": "0.038, -0.745",  # ST创意
    "002124": "0.194, -0.703",  # 天邦食品
    "002122": "0.470, -0.559",  # ST汇洲
    "000698": "0.347, -0.501",  # ST沈化
    "002689": "0.372, -0.615",  # ST远智
    "600624": "0.359, -0.603",  # ST复华
    "600169": "0.289, -0.262",  # ST太重
    "300460": "0.555, -0.522",  # ST惠伦
    "000821": "0.094, -0.657",  # ST京机
    "300173": "0.291, -0.627",  # ST福能
    "000010": "0.662, -0.560",  # *ST美丽
    "000488": "0.285, -0.605",  # ST晨鸣
    "000639": "0.000, -0.752",  # ST西王
    "000826": "0.578, -0.600",  # *ST启环
    "000903": "0.210, -0.690",  # ST云动
    "002055": "0.340, -0.582",  # ST得润
    "002360": "0.394, -0.322",  # ST同德
    "002512": "0.525, -0.494",  # ST达华
    "002691": "0.258, -0.667",  # *ST冀凯
    "002719": "0.354, -0.590",  # ST麦趣
    "301030": "0.402, -0.746",  # *ST仕净
    "600053": "0.013, -0.693",  # *ST九鼎
    "600537": "0.104, -0.740",  # *ST亿晶
    "600734": "0.010, -0.720",  # *ST实达
    "600735": "0.757, -0.407",  # ST新华锦
...
performance_reversal_audit_dict = {
    ...
    "300527": "    财务造假 + 整改已ok + 或将摘帽",  # ST应急
    "300366": "    财务造假 + 整改已ok + 或将摘帽",  # ST创意
    "002124": "    正在重整 + 重整准ok + 或将带帽",   # 天邦食品
    "002122": "    财务造假 + 整改已ok + 或将摘帽",  # ST汇洲
    "000698": "    财务造假 + 整改已ok + 或将摘帽",  # ST沈华
    "002689": "    财务造假 + 整改已ok + 或将摘帽",  # ST远智
    "600624": "    财务造假 + 整改已ok + 或将摘帽",  # ST复华
    "600169": "    财务造假 + 整改已ok + 或将摘帽",  # ST太重
    "300460": "    财务造假 + 整改已ok + 或将摘帽",  # ST惠伦
    "000821": "    财务造假 + 整改已ok + 或将摘帽",  # ST京机
    "300173": "    财务造假 + 整改已ok + 或将摘帽",  # ST福能
    "000010": "    审计无法表示意见 + 待整改 + 重整步骤3庭外接触投资人",  # *ST美丽福能
    "000488": "    审计否定意见&持续经营不确定 + 整改完成大半 + 或将摘帽？",  # ST晨鸣
    "000639": "    审计否定意见&18亿资金挪用 + 待整改 + 或将退市",  # ST西王
    "000826": "    负净资产&持续经营不确定 + 重整步骤7招募投资人 + 可能退市",  # *ST启环
    "000903": "    财务造假&持续经营不确定 + 摘帽未明 + 暂不退市",  # 云动
    "002055": "    财务造假&持续经营不确定 + 摘帽未明 + 暂不退市",  # ST得润
    "002360": "    财保保留&内控否定 + 重整步骤7招募投资人步骤7招募投资人 + 暂不退市",  # ST同德
    "002512": "    财务造假 + 整改已ok + 或将摘帽 + 暂不退市",  # ST达华
...
performance_reversal_memo_dict = {
    ...
    "002360": "    民爆Z药",  # ST同德
    "002512": "    卫星组件运行 + 财务造假 + 正在整改摘帽未知",  # ST达华

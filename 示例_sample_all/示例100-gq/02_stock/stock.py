...
stock_dividend_struct_dict = {
    "600016": "0.352, -0.385",   # 民生银行
    "600755": "0.276, -0.325",   # 厦门国贸
    "601169": "0.667, -0.29",   # 北京银行
    "605368": "0.171, -0.538",   # 蓝天燃气
    "600681": "0.21, -0.397",   # 百川能源
    "603801": "0.06, -0.787",   # 志邦家居
    "601006": "0.058, -0.333",   # 大秦铁路
    "600300": "0.475, -0.3"   # 维维股份
...
limit_up_callback_struct_dict = {
    "600662": "0.276, -0.395",   # 外服控股
    "600681": "0.21, -0.397",   # 百川能源
    "600814": "0.334, -0.464",   # 杭州解百
    "600755": "0.276, -0.325",   # 厦门国贸
    "600858": "0.342, -0.435",   # 银座股份
    "605368": "0.171, -0.538",   # 蓝天燃气
    "605388": "0.208, -0.588"   # 均瑶健康
...
small_cap_callback_struct_dict = {
    "300891": "0.238, -0.469",   # 惠云钛业
    "605077": "0.066, -0.53",   # 华康股份
    "603759": "0.437, -0.545"   # 海天股份
}
...
dividend_fund_struct_dict = {
    "510720": "0.181, -0.099",   # 红利国企ETF国泰
    "159307": "0.27, -0.091",   # 红利低波100ETF博时
    "180102": "0.088, -0.601",   # 华夏合肥高新REIT
    "508056": "0.176, -0.504",   # 中金普洛斯REIT
    "513820": "0.388, -0.141",   # 港股通红利ETF汇添富
    "510880": "0.414, -0.097",   # 红利ETF华泰柏瑞
    "515450": "0.886, -0.068",   # 红利低波50ETF南方
    "515300": "0.683, -0.131"   # 300红利低波ETF嘉实
}

# ---------------------- 0.7：超跌基, 远涨远跌字典 ----------------------
overdown_fund_struct_dict = {
    "512290": "0.303, -0.257",   # 生物医药ETF国泰
    "512010": "0.199, -0.323",   # 医药ETF易方达
    "515710": "0.058, -0.452",   # 食品饮料ETF华宝
    "164906": "0.347, -0.378",   # 中概互联网LOF
    "159766": "0.049, -0.527"   # 旅游ETF富国
}

# ---------------------- 0.8：海外基, 远涨远跌字典 ----------------------
oversea_fund_struct_dict = {
    "512290": "0.298, -0.26",   # 生物医药ETF国泰
    "512010": "0.186, -0.33",   # 医药ETF易方达
    "515710": "0.044, -0.459",   # 食品饮料ETF华宝
    "164906": "0.325, -0.389",   # 中概互联网LOF
    "159766": "0.041, -0.531"   # 旅游ETF富国
}
...
performance_reversal_far_dict = {
    "003032": "0.087, -0.745",   # 传智教育
    "300527": "0.412, -0.448",   # ST应急
    "300366": "0.088, -0.769",   # ST创意
    "002124": "0.235, -0.693",   # 天邦食品
    "002122": "0.404, -0.579",   # ST汇洲
    "000698": "0.311, -0.515",   # ST沈化
    "002689": "0.352, -0.528",   # ST远智
    "600624": "0.439, -0.58",   # ST复华
    "600169": "0.179, -0.325",   # ST太重
    "300460": "0.924, -0.409",   # ST惠伦
    "000821": "0.127, -0.706",   # ST京机
    "300173": "0.161, -0.665",   # ST福能
    "000010": "0.283, -0.663",   # *ST美丽
    "000488": "0.224, -0.634",   # ST晨鸣
    "000826": "0.459, -0.63",   # *ST启环
    "000903": "0.21, -0.69",   # ST云动
    "002055": "0.539, -0.392",   # ST得润
    "002360": "0.329, -0.347",   # ST同德
    "002512": "0.193, -0.61",   # ST达华
    "002691": "0.141, -0.698",   # *ST冀凯
    "002719": "0.23, -0.645",   # ST麦趣
    "301030": "0.169, -0.82",   # *ST仕净
    "600053": "0.093, -0.691",   # *ST九鼎
    "600537": "0.269, -0.701",   # *ST亿晶
    "600734": "0.243, -0.746",   # *ST实达
    "600735": "0.856, -0.374",   # ST新华锦
    "600759": "0.28, -0.744",   # ST洲际
    "688201": "0.237, -0.765"   # ST信安
}

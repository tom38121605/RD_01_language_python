...
stock_dividend_struct_dict = {
    "600755": "0.268, -0.320",  # 厦门国贸
    "600681": "0.286, -0.353",  # 百川能源
    "002807": "0.488, -0.149",  # 江阴银行
    "601169": "0.641, -0.301",  # 北京银行
    "603801": "0.007, -0.720",  # 志邦家居
    "000001": "0.449, -0.212",  # 平安银行
    "601916": "0.416, -0.226",  # 浙商银行
    "605368": "0.247, -0.508",  # 蓝天燃气
    "600016": "0.385, -0.363",  # 民生银行
    "601006": "0.068, -0.279",  # 大秦铁路
...
limit_up_callback_struct_dict = {
    ...
    "600662": "0.338, -0.347",  # 外服控股
    "600814": "0.468, -0.411",  # 杭州解百
    "600755": "0.268, -0.320",  # 厦门国贸
...
dividend_fund_struct_dict = {
    ...
    "510720": "0.202, -0.076",  # 红利国企ETF国泰
    "515450": "0.943, -0.040",  # 红利低波50ETF南方
    "515300": "0.742, -0.101",  # 300红利低波ETF嘉实
    "159307": "0.312, -0.056",  # 红利低波100ETF博时
    "510880": "0.451, -0.073",  # 红利ETF华泰柏瑞
    "513820": "0.487, -0.079",  # 港股通红利ETF汇添富
    "180102": "0.000, -0.538",  # 华夏合肥高新REIT
...
performance_reversal_far_dict = {
    "003032": "0.461, -0.657",  # *ST传智
    "002124": "0.307, -0.674",  # 天邦食品
    "000903": "0.089, -0.721",  # ST云动
    "300527": "0.468, -0.426",  # ST应急
    "300366": "0.076, -0.735",  # ST创意
    "002122": "0.519, -0.545",  # ST汇洲
    "000698": "0.371, -0.493",  # ST沈化
    "002689": "0.517, -0.567",  # ST远智
    "600624": "0.543, -0.549",  # ST复华
    "600169": "0.283, -0.265",  # ST太重
    "300460": "0.781, -0.453",  # ST惠伦
    "000821": "0.005, -0.661",  # ST京机
    "300173": "0.270, -0.633",  # ST福能
    "600759": "0.273, -0.725",  # ST洲际
    "000639": "0.074, -0.723",  # ST西王
    "688201": "0.362, -0.739",  # ST信安
    "000010": "0.374, -0.636",  # *ST美丽
    "301030": "0.427, -0.742",  # *ST仕净
    "600735": "1.042, -0.311",  # ST新华锦
    "600053": "0.016, -0.661",  # *ST九鼎
    "600581": "0.020, -0.550",  # *ST八钢
    "002691": "0.326, -0.639",  # *ST冀凯
    "000488": "0.385, -0.574",  # ST晨鸣
    "002360": "0.461, -0.289",  # ST同德
    "000826": "0.681, -0.574",  # *ST启环
    "600537": "0.412, -0.662",  # *ST亿晶
    "600734": "0.040, -0.712",  # *ST实达
    "002512": "0.701, -0.436",  # ST达华
    "002055": "0.687, -0.474",  # ST得润
}

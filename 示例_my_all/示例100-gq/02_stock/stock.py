...
dividend_stock_date_dict = {
    ...
    "600219": ["25年报 26/03/27", "大会 26/04/16", "0.4+2.584+1.36"],    # 南山铝业
    "605368": ["25年报 26/04/22", "大会 无效", "4+0"],    # 蓝天燃气
    "600755": ["25年报 26/04/23", "大会 26/05/13", "1.0+1.2"],   # 厦门国贸
    "600256": ["25年报 26/04/24", "大会 26/05/20", "0.63"],    # 广汇能源

    "002267": ["25年报 26/05/28", "预案 26/05/22", "2.0"],    # 陕天然气
    "601169": ["25年报 26/04/28", "预案 26/05/21", "2.78"],    # 北京银行
    "002807": ["25年报 26/04/29", "预案 26/05/19", "1.0+1.2"],    # 江阴银行
    "600681": ["25年报 26/04/29", "预案 26/05/19", "0.9+0.6"],    # 百川能源
...
limit_up_callback_dividend_date_dict = {
    "600858": ["25年报 26/04/24", "预案 26/04/24", "0.15+0.2"],  # 银座股份
    "600681": ["25年报 26/04/29", "预案 26/04/29", "0.9+0.6"],  # 百川能源
    "605368": ["25年报 26/04/29", "预案 26/04/22", "4+0"],  # 蓝天燃气
    "600755": ["25年报 26/04/23", "预案 26/04/23", "1.0+1.2"],  # 厦门国贸
    "600814": ["25年报 26/03/27", "预案 26/03/27", "0.41+0.84"],  # 杭州解百
...
def get_performance_reversal_sort_key(item):  # 业绩反转
    code = item[0]

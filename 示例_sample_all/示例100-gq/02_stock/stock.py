...
stock_dividend_struct_dict = {
    "600016": "0.283, -0.412",    # 民生银行
    "600755": "0.204, -0.362",    # 厦门国贸
    "601169": "0.589, -0.323",    # 北京银行
    "605368": "0.101, -0.566",    # 蓝天燃气
    "600681": "0.149, -0.427",    # 百川能源
    "603801": "0.013, -0.796",    # 志邦家居
    "601006": "0.020, -0.357",    # 大秦铁路
    "600300": "0.396, -0.338"     # 维维股份
...
limit_up_callback_struct_dict = {
    "600662": "0.236, -0.414",  # 外服控股
    "600681": "0.149, -0.427",  # 百川能源
    "600814": "0.270, -0.490",  # 杭州解百
    "600755": "0.204, -0.362",  # 厦门国贸
    "600858": "0.278, -0.462",  # 银座股份
    "605368": "0.101, -0.566",  # 蓝天燃气
    "605388": "0.156, -0.606"  # 均瑶健康
...
small_cap_callback_struct_dict = {
    "300891": "0.168, -0.499",    # 惠云钛业
    "605077": "0.035, -0.543",    # 华康股份
    "603759": "0.301, -0.582"     # 海天股份
}
...
dividend_fund_struct_dict = {
    "510720": "0.106, -0.156",    # 红利国企ETF国泰
    "180102": "0.059, -0.612",    # 华夏合肥高新REIT
    "159307": "0.214, -0.131",    # 红利低波100ETF博时
    "513820": "0.325, -0.181",    # 港股通红利ETF汇添富
    "510880": "0.335, -0.147",    # 红利ETF华泰柏瑞
    "515450": "0.806, -0.108",    # 红利低波50ETF南方
    "515300": "0.623, -0.162",    # 300红利低波ETF嘉实
    "508056": "0.105, -0.530"     # 中金普洛斯REIT
}

# ---------------------- 0.7：超跌基, 远涨远跌字典 ----------------------
overdown_fund_struct_dict = {
    "512290": "0.224, -0.303",  # 生物医药ETF国泰
    "512010": "0.144, -0.354",  # 医药ETF易方达
    "515710": "0.029, -0.467",  # 食品饮料ETF华宝
    "164906": "0.284, -0.408"   # 中概互联网LOF
}

# ---------------------- 0.8：海外基, 远涨远跌字典 ----------------------
oversea_fund_struct_dict = {
    "159329": "0.029, -0.324",    # 沙特ETF南方
    "164824": "0.170, -0.257",    # 印度基金LOF
    "161126": "0.191, -0.160",    # 标普医疗保健LOF
    "159100": "0.166, -0.211"     # 巴西ETF华夏
}
...
performance_reversal_far_dict = {
    "003032": "0.047, -0.754",  # 传智教育
    "300527": "0.264, -0.506",  # ST应急
    "300366": "0.033, -0.780",  # ST创意
    "002124": "0.077, -0.732",  # 天邦食品
    "002122": "0.267, -0.624",  # ST汇洲
    "000698": "0.187, -0.560",  # ST沈化
    "002689": "0.239, -0.571",  # ST远智
    "600624": "0.181, -0.657",  # ST复华
    "600169": "0.098, -0.371",  # ST太重
    "300460": "0.767, -0.457",  # ST惠伦
    "000821": "0.062, -0.722",  # ST京机
    "300173": "0.112, -0.679",  # ST福能
    "000010": "0.232, -0.676",  # *ST美丽
    "000488": "0.139, -0.659",  # ST晨鸣
    "000826": "0.415, -0.642",  # *ST启环
    "00903": "0.146, -0.706",   # ST云动
    "002055": "0.414, -0.442",  # ST得润
    "002360": "0.190, -0.422",  # ST同德
    "002512": "0.135, -0.629",  # ST达华
    "002691": "0.056, -0.720",  # *ST冀凯
    "002719": "0.151, -0.668",  # ST麦趣
    "301030": "0.232, -0.811",  # *ST仕净
    "600053": "0.027, -0.710",  # *ST九鼎
    "600537": "0.198, -0.718",  # *ST亿晶
    "600734": "0.041, -0.788",  # *ST实达
    "600735": "0.830, -0.382",  # ST新华锦
    "600759": "0.005, -0.799",  # ST洲际
    "688201": "0.167, -0.778"   # ST信安
}
...
def write_sheet_data1(
    ...
    col_widths3 = {    # K=10
        ...
        8: 8, 9: 8, 10: 19, 11: 7, 12: 6, 13: 6, 14: 60, 15: 30
    }

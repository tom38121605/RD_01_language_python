...
# 大盘上升趋势 ，高位震荡趋势
# FARUP_LOW, FARUP_HIGH = 40, 60         # 远涨
# FARDOWN_LOW, FARDOWN_HIGH  = 30 , 60   # 远跌
...
full_far_dict = {
    ...
    "000010": "0.123, -0.705, 0.026, -0.641",   # *ST美丽
    "000488": "0.139, -0.659, 0.027, -0.331",   # ST晨鸣
    "000698": "0.255, -0.535, 0.117, -0.207",   # ST沈化
    "000821": "0.012, -0.754, 0.012, -0.438",   # ST京机
    "000903": "0.032, -0.735, 0.012, -0.375",   # ST云动
    "002055": "0.246, -0.529, 0.019, -0.36",   # ST得润
    "002122": "0.272, -0.622, 0.096, -0.248",   # ST汇洲
    "002124": "0.122, -0.719, 0.084, -0.329",   # 天邦食品
    "002360": "0.284, -0.376, 0.179, -0.275",   # ST同德
    "002512": "0.179, -0.615, 0.077, -0.394",   # ST达华
    "002689": "0.293, -0.549, 0.083, -0.326",   # ST远智
    "002691": "0.015, -0.755, 0.015, -0.535",   # *ST冀凯
    "002719": "0.038, -0.7, 0.008, -0.415",   # ST麦趣
    "003032": "0.141, -0.734, 0.141, -0.267",   # 传智教育
    "300087": "0.056, -0.664, 0.056, -0.43",   # ST荃银
    "300173": "0.042, -0.699, 0.014, -0.34",   # ST福能
    "300366": "0.017, -0.79, 0.017, -0.307",   # ST创意
    "300527": "0.369, -0.465, 0.121, -0.156",   # ST应急
    "300891": "0.1, -0.528, 0.017, -0.326",   # 惠云钛业
    "301030": "0.029, -0.856, 0.029, -0.487",   # *ST仕净
    "600016": "0.429, -0.35, 0.121, -0.049",   # 民生银行
    "600053": "0.022, -0.735, 0.022, -0.55",   # *ST九鼎
    "600169": "0.156, -0.338, 0.099, -0.18",   # ST太重
    "600300": "0.545, -0.268, 0.139, -0.148",   # 维维股份
    "600537": "0.038, -0.758, 0.038, -0.503",   # *ST亿晶
    "600624": "0.217, -0.646, 0.057, -0.3",   # ST复华
    "600662": "0.298, -0.385, 0.085, -0.189",   # 外服控股
    "600681": "0.217, -0.394, 0.096, -0.167",   # 百川能源
    "600734": "0.081, -0.779, 0.081, -0.585",   # *ST实达
    "600755": "0.287, -0.319, 0.082, -0.084",   # 厦门国贸
    "600759": "0.484, -0.696, 0.484, -0.527",   # ST洲际
    "600814": "0.372, -0.455, 0.095, -0.169",   # 杭州解百
    "600858": "0.348, -0.432, 0.086, -0.203",   # 银座股份
    "601006": "0.107, -0.31, 0.107, -0.103",   # 大秦铁路
    "603759": "0.327, -0.58, 0.046, -0.271",   # 海天股份
    "603801": "0.049, -0.793, 0.049, -0.384",   # 志邦家居
    "603825": "0.035, -0.662, 0.035, -0.298",   # ST华扬
    "605077": "0.011, -0.567, 0.011, -0.464",   # 华康股份
    "605368": "0.2, -0.517, 0.143, -0.186",   # 蓝天燃气
    "605388": "0.182, -0.597, 0.044, -0.457",   # 均瑶健康
    "688201": "0.089, -0.794, 0.012, -0.552",   # ST信安
    "159100": "0.153, -0.219, 0.048, -0.176",   # 巴西ETF华夏
    "159307": "0.324, -0.05, 0.109, -0.024",   # 红利低波100ETF博时
    "159329": "0.003, -0.352, 0.003, -0.086",   # 沙特ETF南方
    "159766": "0.04, -0.535, 0.04, -0.206",   # 旅游ETF富国
    "161126": "0.249, -0.12, 0.081, -0.057",   # 标普医疗保健LOF
    "164824": "0.158, -0.264, 0.028, -0.043",   # 印度基金LOF
    "164906": "0.435, -0.338, 0.155, -0.096",   # 中概互联网LOF
    "180102": "0.091, -0.6, 0.091, -0.327",   # 华夏合肥高新REIT
    "508056": "0.138, -0.52, 0.127, -0.221",   # 中金普洛斯REIT
    "510720": "0.238, -0.056, 0.128, -0.049",   # 红利国企ETF国泰
    "510880": "0.484, -0.052, 0.119, -0.035",   # 红利ETF华泰柏瑞
    "512010": "0.229, -0.306, 0.194, -0.02",   # 医药ETF易方达
    "512290": "0.305, -0.255, 0.224, -0.043",   # 生物医药ETF国泰
    "513820": "0.462, -0.096, 0.106, -0.055",   # 港股通红利ETF汇添富
    "515300": "0.776, -0.083, 0.106, -0.029",   # 300红利低波ETF嘉实
    "515450": "1.0, -0.019, 0.109, -0.007",   # 红利低波50ETF南方
    "515710": "0.115, -0.423, 0.115, -0.091",   # 食品饮料ETF华宝
    "123265": "0.033, -0.414, 0.033, -0.234",   # 耐普转02
    "123266": "0.1, -0.091, 0.1, -0.091",   # 博士转债
    "127025": "0.055, -0.063, 0.004, -0.003",   # 冀东转债
    "000016": "0.283, -0.69, 0.121, -0.341",   # *ST康佳A
    "113701": "0.094, -0.371, 0.018, -0.371",   # 祥和转债
    "300211": "0.345, -0.619, 0.009, -0.374",   # *ST亿通
...
dividend_stock_date_dict = {
    ...
    # here
    "601006": ["25年报 26/04/30", "登记 过期 26/07/10", "1.4+0.8"],  # 大秦铁路
    "600681": ["25年报 26/04/29", "登记 过期 26/06/03", "0.9+0.6"],   # 百川能源
    "605368": ["25年报 26/04/29", "大会 过期 26/05/13", "4+0"],       # 蓝天燃气
    "600016": ["25年报 26/03/31", "登记 过期 26/07/02 ", "1.36+0.53"],    # 民生银行
    "603801": ["25年报 26/04/30", "登记 过期 26/06/22", "4.0"],       # 志邦家居
    "600300": ["25年报 26/04/30", "登记 过期 26/05/27", "1.04"],      # 维维股份
    "601169": ["25年报 26/04/28", "登记 过期 26/07/10", "2.78"],  # 北京银行
...
small_cap_dividend_date__dict = {
    ...
    # going
     ...
     #here
    "603759": ["25年报 配债 26/04/30", "除息 过期 26/07/02", "1.15"],  # 海天股份
    "300891": ["25年报 26/04/21", "预案 无效 26/04/21", "0.0"],  # 惠云钛业
    "605077": ["25年报 超跌 26/04/30", "除息 过期 26/06/17", "2.0+3.0"],  # 华康股份
}
...
fund_dividend_date_dict = {
    ...
    # goning
    "510720": ["登记 26/07/13", "预计 26/08/13", "0.03*12" ],  # 红利国企，模仿上次填       # 每月
    "159307": ["登记 26/06/11 ", "预计 26/09/11", "0.13*4"],   # 红利100博时，模仿上次填    #每季 （分红3-4次）
    "180102": ["登记 26/04/20", "预计 26/08/20", "0.36*2"],    # 合肥高新                  # 每半年
    "508056": ["登记 26/07/02", "预计 26/10/31", "0.33*4"],      # 普洛斯                    # 每季

    # 备用
    "513820": ["登记 26/05/24", "预计 26/06/23", "0.01*12" ],  # 港股通红利，模仿上次填     # 每月
    "515300": ["登记  25/06/16", "预计  26/06/16", "0.228*4" ],  # 300红利 ，模仿上次填     #每季 （分红3-4次）
    "515450": ["登记 25/07/14", "预计 26/07/14", "0.3*2" ],  # 红利50南方，模仿上次填       # 每半年
    "510880": ["登记 26/01/20", "预计 27/01/20", "1.43" ],  # 红利ETF华泰柏瑞，模仿上次填    # 每年
...
performance_reversal_audit_dict = {
    ...
    "000010": "  财报内控双无法表示意见&挪用2.7亿 + 重整步骤3庭外接触投资人 + 可能退市",  # *ST美丽
    ...
    "603825": "  财务造假 + 整改已ok + 或将摘帽 + 暂不退市",  # ST华扬
    "000016": "  负净资产60亿&持续经营不确定 + 很难摘帽 + 可能退市",  # *ST康佳A
    "300211": "  财务亏损 + 营收已ok + 已申请摘帽",  # 亿通
...
# 每网，基金平均每个点不超过300元，股票平均每个点不超过250元
full_trade_dict = {

    # 分红股
    "600016": "  中网格  + 中短线  + 回本退出",     # 民生银行
    "600755": "  中网格  + 中短线  + 图形到位退出",  # 厦门GM
    "605368": "  小网格  + 中短线  + 回本退出",     # 蓝天RQ
    "600681": "  小网格  + 中长线  + 图形到位退出",  # 百川能源
    "603801": "  微小网格 + 长 线  + 长持等海外增长",  #志邦家居
    "601006": "  中网格   + 中短线 + 回本退出",       # 大秦铁路
    "600300": "  中网格   + 中短线 + 回本退出",       # 维维股份

    # 涨停回调
    "600662": "  中网格 + 中短线 + 图形退出",  # 外服KG
    "600814": "  中网格 + 中短线 + 图形退出",  # 杭州解百
    "600858": "  大网格 + 中短线 + 图形退出",  # 银座股份
    "605388": "  大网格 + 中短线 + 图形退出",  # 均瑶健康

    # 小盘猛牛
    "300891": "  中网格 + 中线 + 图形退出",  # 惠云钛业
    ...
    # 分红基
    "510720": "  小网格 + 中线 + 轮回循环",  # 红利国企
    "159307": "  小网格 + 中线 + 轮回循环",  # 红利100
    ...
    "159766": "  小网格 + 中线 + 轮回循环",  # 旅游etf

    # 海外基
    "159329": "  小网格 + 中线 + 轮回循环",  # 沙特南方
    "164824": "  小网格 + 中线 + 轮回循环",  # 印度etf
    "161126": "  小网格 + 中线 + 轮回循环",  # 标普医疗
    "159100": "  小网格 + 中线 + 轮回循环",  # 巴西etr

    # 可转债
    "123266": "  中网格 + 短线 + 回本退出",  # 博士转债
    "123265": "  中网格 + 短线 + 回本退出",  # 耐普转债
    ...
    "002122": "  中网格 + 短线 + 轮回退出",  # st汇洲
    "000698": "  中网格 + 短线 + 轮回退出",  # st沈化
    "002689": "  中网格 + 短线 + 轮回退出",  # st远智
    "600624": "  中网格 + 短线 + 轮回退出",  # st复华
    "600169": "  中网格 + 短线 + 轮回退出",  # st太重
    "000821": "  中网格 + 短线 + 轮回退出",  # st京机
    ...
    "301030": "  中网格 + 超短线 + 轮回退出",  # *st仕净
    "600053": "  中网格 + 超短线 + 轮回退出",  # *st九鼎
    "600537": "  中网格 + 短线 + 轮回退出",  # *st亿晶体
    "600734": "  中网格 + 超短线 + 轮回退出",  # *st实达
    "600735": "  中网格 + 短线 + 轮回退出",  # st新华锦
...
def parse_date(date_str):   # 内部子函数
    ...
    if not date_str or "待定"  in date_str or "无效"  in date_str or "过期"  in date_str:   # 日期为"", 或含有"无效", "待定"，"过期"，返回 2099/12/31
...
def write_sheet_data1(
    ...
    # 重新计算累积金额，累积仓位%，排名  //为何要重新计算   -- 因为之前本来就不是本策略的累计金额和累计仓位

...
full_far_dict = {
    "000010": "0.275, -0.665, 0.073, -0.644",   # *ST美丽
    "000488": "0.212, -0.638, 0.093, -0.373",   # ST晨鸣
    "000698": "0.247, -0.538, 0.11, -0.27",   # ST沈化
    "000821": "0.093, -0.714, 0.093, -0.533",   # ST京机
    "000826": "0.393, -0.647, 0.093, -0.384",   # *ST启环
    "000903": "0.159, -0.703, 0.046, -0.364",   # ST云动
    "002055": "0.501, -0.407, 0.163, -0.168",   # ST得润
    "002122": "0.354, -0.594, 0.177, -0.242",   # ST汇洲
    "002124": "0.179, -0.705, 0.138, -0.296",   # 天邦食品
    "002360": "0.299, -0.362, 0.207, -0.258",   # ST同德
    "002512": "0.284, -0.574, 0.19, -0.486",   # ST达华
    "002689": "0.303, -0.546, 0.091, -0.368",   # ST远智
    "002691": "0.106, -0.707, 0.089, -0.566",   # *ST冀凯
    "002719": "0.175, -0.661, 0.119, -0.415",   # ST麦趣
    "003032": "0.057, -0.752, 0.057, -0.317",   # 传智教育
    "300173": "0.147, -0.669, 0.086, -0.334",   # ST福能
    "300366": "0.112, -0.764, 0.112, -0.348",   # ST创意
    "300460": "0.772, -0.456, 0.203, -0.117",   # ST惠伦
    "300527": "0.492, -0.417, 0.222, -0.13",   # ST应急
    "300891": "0.194, -0.488, 0.061, -0.421",   # 惠云钛业
    "301030": "0.164, -0.821, 0.164, -0.455",   # *ST仕净
    "600016": "0.352, -0.385, 0.06, -0.158",   # 民生银行
    "600053": "0.09, -0.692, 0.09, -0.692",   # *ST九鼎
    "600169": "0.168, -0.331, 0.11, -0.212",   # ST太重
    "600300": "0.47, -0.303, 0.084, -0.212",   # 维维股份
    "600537": "0.212, -0.714, 0.108, -0.415",   # *ST亿晶
    "600624": "0.338, -0.609, 0.167, -0.337",   # ST复华
    "600662": "0.273, -0.397, 0.064, -0.357",   # 外服控股
    "600681": "0.203, -0.401, 0.083, -0.36",   # 百川能源
    "600734": "0.169, -0.761, 0.169, -0.645",   # *ST实达
    "600735": "0.83, -0.382, 0.143, -0.192",   # ST新华锦
    "600755": "0.313, -0.3, 0.112, -0.135",   # 厦门国贸
    "600759": "0.355, -0.723, 0.355, -0.723",   # ST洲际
    "600814": "0.332, -0.465, 0.067, -0.428",   # 杭州解百
    "600858": "0.33, -0.44, 0.072, -0.361",   # 银座股份
    "601006": "0.068, -0.334, 0.068, -0.134",   # XD大秦铁
    "603759": "0.373, -0.565, 0.082, -0.439",   # 海天股份
    "603801": "0.044, -0.794, 0.044, -0.424",   # 志邦家居
    "605077": "0.033, -0.555, 0.033, -0.449",   # 华康股份
    "605368": "0.162, -0.542, 0.086, -0.339",   # 蓝天燃气
    "605388": "0.191, -0.594, 0.053, -0.453",   # 均瑶健康
    "688201": "0.226, -0.767, 0.094, -0.587",   # ST信安
    "159100": "0.143, -0.226, 0.038, -0.226",   # 巴西ETF华夏
    "159307": "0.26, -0.098, 0.053, -0.094",   # 红利低波100ETF博时
    "159329": "0.002, -0.343, 0.002, -0.101",   # 沙特ETF南方
    "159766": "0.036, -0.536, 0.036, -0.35",   # 旅游ETF富国
    "161126": "0.253, -0.117, 0.084, -0.053",   # 标普医疗保健LOF
    "164824": "0.173, -0.255, 0.041, -0.104",   # 印度基金LOF
    "164906": "0.393, -0.357, 0.121, -0.276",   # 中概互联网LOF
    "180102": "0.105, -0.595, 0.105, -0.365",   # 华夏合肥高新REIT
    "508056": "0.166, -0.509, 0.154, -0.271",   # 中金普洛斯REIT
    "510720": "0.164, -0.112, 0.06, -0.105",   # 红利国企ETF国泰
    "510880": "0.394, -0.109, 0.051, -0.105",   # 红利ETF华泰柏瑞
    "512010": "0.186, -0.33, 0.152, -0.072",   # 医药ETF易方达
    "512290": "0.287, -0.267, 0.205, -0.047",   # 生物医药ETF国泰
    "513820": "0.388, -0.141, 0.051, -0.108",   # 港股通红利ETF汇添富
    "515300": "0.685, -0.131, 0.049, -0.106",   # 300红利低波ETF嘉实
    "515450": "0.879, -0.072, 0.048, -0.072",   # 红利低波50ETF南方
    "515710": "0.047, -0.458, 0.047, -0.222",   # 食品饮料ETF华宝
    "123265": "0.036, -0.412, 0.036, -0.412",   # 耐普转02
    "123266": "0.049, -0.133, 0.049, ",   # 博士转债
    "127025": "0.053, -0.065, 0.002, -0.016",   # 冀东转债

    "002726": "0.350, -0.638, 0.350, -0.849",  # st龙大
...
dividend_stock_date_dict = {
    ...
    "601006": ["25年报 26/04/30", "大会 待定 26/05/22", "1.4+0.8"],  # 大秦铁路
    "601169": ["25年报 26/04/28", "大会 待定 26/05/21", "2.78"],     # 北京银行

    # here
    "600681": ["25年报 26/04/29", "登记 过期 26/06/03", "0.9+0.6"],   # 百川能源
    "605368": ["25年报 26/04/29", "大会 过期 26/05/13", "4+0"],       # 蓝天燃气
    "600016": ["25年报 26/03/31", "登记 26/07/01 ", "1.36+0.53"],    # 民生银行

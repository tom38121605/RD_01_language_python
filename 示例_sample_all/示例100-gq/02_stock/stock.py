...
stock_dividend_struct_dict = {
    "600016": "0.385, -0.363",    # 民生银行
    "600755": "0.251, -0.338",    # 厦门国贸
    "601169": "0.654, -0.296",    # 北京银行
    "605368": "0.195, -0.529",    # 蓝天燃气
    "600681": "0.228, -0.388",    # 百川能源
    "603801": "0.036, -0.773",    # XD志邦家居
    "601006": "0.021, -0.315",    # 大秦铁路
...
limit_up_callback_struct_dict = {
    "600662": "0.288, -0.390",    # 外服控股
    "600681": "0.228, -0.388",    # 百川能源
    "600814": "0.395, -0.440",    # 杭州解百
    "600755": "0.251, -0.338",    # 厦门国贸
    "600858": "0.380, -0.419",    # 银座股份
    "605368": "0.195, -0.529",    # 蓝天燃气
...
small_cap_callback_struct_dict = {
    "300891": "0.315, -0.417",  # 惠云钛业
    "605077": "0.145, -0.495",  # 华康股份
    "603759": "0.421, -0.544"  # 海天股份
}
...
dividend_fund_struct_dict = {
    "510720": "0.186, -0.095",  # 红利国企ETF国泰
    "180102": "0.014, -0.611",  # 华夏合肥高新REIT
    "159307": "0.269, -0.092",  # 红利低波100ETF博时
    "513820": "0.386, -0.142",  # 港股通红利ETF汇添富
    "510880": "0.421, -0.092",  # 红利ETF华泰柏瑞
    "515450": "0.878, -0.072",  # 红利低波50ETF南方
    "515300": "0.689, -0.129"  # 300红利低波ETF嘉实
...
performance_reversal_far_dict = {
    "003032": "0.173, -0.724",    # 传智教育
    "300527": "0.384, -0.459",    # ST应急
    "300366": "0.058, -0.749",    # ST创意
    "002124": "0.128, -0.720",    # 天邦食品
    "002122": "0.354, -0.594",    # ST汇洲
    "000698": "0.235, -0.543",    # ST沈化
    "002689": "0.342, -0.541",    # ST远智
    "600624": "0.363, -0.602",    # ST复华
    "600169": "0.185, -0.321",    # ST太重
    "300460": "0.722, -0.471",    # ST惠伦
    "000821": "0.011, -0.698",    # ST京机
    "300173": "0.253, -0.638",    # ST福能
    "000010": "0.439, -0.619",    # *ST美丽
    "000488": "0.261, -0.623",    # ST晨鸣
    "000639": "0.065, -0.770",    # ST西王
    "000826": "0.496, -0.621",    # *ST启环
    "000903": "0.248, -0.680",    # ST云动
    "002055": "0.407, -0.458",    # ST得润
    "002360": "0.294, -0.375",    # ST同德
    "002512": "0.388, -0.539",    # ST达华
    "002691": "0.213, -0.679",    # *ST冀凯
    "002719": "0.287, -0.611",    # ST麦趣
    "301030": "0.150, -0.799",    # *ST仕净
    "600053": "0.087, -0.685",    # *ST九鼎
    "600537": "0.250, -0.706",    # *ST亿晶
    "600734": "0.022, -0.745",    # *ST实达
    "600735": "0.780, -0.399",    # ST新华锦
    "600759": "0.151, -0.757",    # ST洲际石油
    "688201": "0.244, -0.763"     # ST信安
}
...
dividend_stock_date_dict = {
    ...
    "603801": ["25年报 26/04/30", "除息 26/06/23", "4.0"],    # 志邦家居
...
fund_dividend_date_dict = {
    ...
    # 每月
    "510720": ["登记 26/06/15", "预计 26/07/13", "0.03*12" ],  # 红利国企，模仿上次填
    "513820": ["登记 26/05/24", "预计 26/06/23", "0.01*12" ],  # 港股通红利，模仿上次填

    #每季 （分红3-4次）
    "180102": ["登记 26/04/20", "预计 26/08/20", "0.36*2"],     # 合肥高新
